        ...
        <aside className="h-[100vh] overflow-y-auto relative bg-[#F7F8FA] dark:bg-black border-r-[1px] border-b-[1px] border-[#EBECF2]">
          ...
          <ul className="py-2 [&>li:nth-child(8)]:px-4 [&>li:nth-child(8)]:mt-6 lg:[&>li:nth-child(8)]:absolute lg:[&>li:nth-child(8)]:bottom-0 [&>li:nth-child(3)]:left-[50%] [&>li:nth-child(3)]:-translate-x-[50%] dark:[&>li>a>svg>path]:stroke-white text-[0.84em]">
            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:fill-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              ...
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-black dark:bg-white rounded-full"
                }
              ></span>
            </li>

            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              <a
                className="py-2 [&>*>svg]:hover:fill-black [&>*]:hover:text-[#34CAA5] [&>*]:hover:font-semibold flex flex-row items-center justify-start space-x-2"
                href={`/`}
              >
                ...
                <span className="lg:hidden block">Total Income</span>
              </a>
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-none rounded-full"
                }
              ></span>
            </li>
            ...
            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              ...
              >
                ...
                <span className="lg:hidden block">Account</span>
              </a>
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-none rounded-full"
            ...
            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              ...
              >
                ...
                <span className="lg:hidden block">Inventory</span>
              </a>
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-none rounded-full"
            ...
            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              ...
              >
                ...
                <span className="lg:hidden block">Average Sales</span>
              </a>
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-none rounded-full"
            ...
            <li className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5] dark:[&>a>svg>path]:hover:stroke-[#34CAA5]">
              ...
              >
                ...
                <span className="lg:hidden block">Defective Products</span>
              </a>
              <span
                className={
                  "absolute top-[50%] right-[99%] lg:right-0 translate-y-[-50%] w-1 h-[24px] bg-none rounded-full"
            ...
            <li
              onClick={applyTheme}
              className="my-3 relative grid lg:place-content-center place-content-start lg:px-0 px-4 [&>span]:hover:bg-[#34CAA5] [&>a>svg>path]:hover:stroke-[#34CAA5] [&>a>span]:hover:text-[#34CAA5]"
            >
              <input
                type="checkbox"
                id="check"
            ...
            <li className="lg:left-[50%] lg:-translate-x-[50%] flex flex-col justify-center gap-4 mb-6">
              <a
                href=""
                className="my-1 w-full flex flex-row items-center justify-start gap-2 [&>svg>path]:hover:stroke-[#34CAA5] [&>span]:hover:text-[#34CAA5] dark:[&>svg>path]:hover:stroke-[#34CAA5]"
              >
                {" "}
                <svg
                  width="24"
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="cursor-pointer [&>path]:hover:stroke-[#34CAA5]"
                >
                  <path
                    d="M8.5 12H14.5"
                    stroke="#B2ABAB"
                ...
                <span className="lg:hidden block">Total Order</span>
              </a>
              <a
                href=""
                className="my-1 w-full flex flex-row items-center justify-start gap-2 [&>svg>path]:hover:stroke-[#34CAA5] [&>span]:hover:text-[#34CAA5] dark:[&>svg>path]:hover:stroke-[#34CAA5]"
              >
                ...
                <span className="lg:hidden block">Settings</span>
              </a>
              <a
                href=""
                className="my-1 w-full flex flex-row items-center justify-start gap-2 [&>svg>path]:hover:stroke-[#E85B67] [&>span]:hover:text-[#E85B67] dark:[&>svg>path]:hover:stroke-[#34CAA5]"
              >
                {" "}
                <svg
                  width="24"
