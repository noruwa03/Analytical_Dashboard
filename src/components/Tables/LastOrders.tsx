        ...
        <div className="overflow-x-auto my-3">
          <table className="table-auto overflow-x-auto w-full divide-y divide-gray-100 text-sm">
            ...
            <tbody className="text-[0.9em] divide-y divide-gray-100 dark:[&>tr>td>svg>path]:fill-white">
              <tr className="flex flex-row items-center justify-between py-3 gap-3 cursor-auto">
                <td className="w-40 text-start flex flex-row items-center justify-start gap-4">
                  <img
                    src="/marcus.png"
                    alt="Avatar"
                    width="64"
                  ...
                  />
                  <p className="font-medium">Marcus Bergson</p>
                </td>
              ...
              <tr className="flex flex-row items-center justify-between py-3 gap-3">
                <td className="w-40 text-start flex flex-row items-center justify-start gap-4">
                  <img
                    src="/jaydon.png"
                    alt="Avatar"
                    ...
                    className="w-8 h-8 rounded-full object-cover cursor-pointer"
                  />
                  <p className="font-medium">Jaydon Vaccaro</p>
                </td>
                <td className="w-20 text-start text-[#737373]">Nov 15, 2023</td>
              ...
              <tr className="flex flex-row items-center justify-between py-3 gap-3">
                <td className="w-40 text-start flex flex-row items-center justify-start gap-4">
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover cursor-pointer"
                  />
                  <p className="font-medium">Corey Schleifer</p>
                </td>
              ...
              <tr className="flex flex-row items-center justify-between py-3 gap-3">
                <td className="w-40 text-start flex flex-row items-center justify-start gap-4">
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover cursor-pointer"
                  />
                  <p className="font-medium">Cooper Press</p>
                </td>
                <td className="w-20 text-start text-[#737373]">Nov 15, 2023</td>
              ...
              <tr className="flex flex-row items-center justify-between py-3 gap-3">
                <td className="w-40 text-start flex flex-row items-center justify-start gap-4">
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover cursor-pointer"
                  />
                  <p className="font-medium">Phillip Lubin</p>
                </td>
