  ...
  return (
    <>
      {invoiceModal && (
        <Invoice
          close={toggleClose}
          fullname={tableData[currentIndex].fullname}
          date={tableData[currentIndex].date}
          amount={tableData[currentIndex].amount}
          status={tableData[currentIndex].status}
        />
      )}
